	...
	public partial class EfCoreModelDialog
	{
		...
		public EfCoreModelDialog(ReverseEngineerOptions options)
		{
			...
			if (_options != null)
			{
				...
				chkFullNamespace.IsChecked = options.UseFullNamespace;
				...
				chkExcludeStringLengthAttribute.IsChecked = options.ExcludeStringLengthAttribute;
				SetCheckState();
			}
		}
		...
		public bool UseFullNamespace => chkFullNamespace.IsChecked != null && chkFullNamespace.IsChecked.Value;
		...
		public bool ExcludeStringLengthAttribute => chkExcludeStringLengthAttribute.IsChecked != null && chkExcludeStringLengthAttribute.IsChecked.Value;
