...
namespace ReverseEngineer20
{
	public class EfCoreReverseEngineer
	{
		public EfCoreReverseEngineerResult GenerateFiles(ReverseEngineerOptions reverseEngineerOptions)
		{
			...
			EGCustomChanges.Generate(filePaths.AdditionalFiles, reverseEngineerOptions.ConnectionString, outputFolder, reverseEngineerOptions.ExcludeStringLengthAttribute);
